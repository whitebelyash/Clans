...
public class AllyChatCommandBukkit extends SimpleCommand<CommandSender> implements CommandExecutor, TabCompleter {
    public AllyChatCommandBukkit() {
        super(new AllyChatCommand());
    }
